...
//
//    private final UUID tripId = UUID.fromString("11111111-1111-1111-1111-111111111111");
//
...
//
//        Mockito.when(pointService.findByTripId(tripId)).thenReturn(List.of(point));
//
...
//        Point point = samplePoint();
//
//        Mockito.when(pointService.findById(tripId, 10L)).thenReturn(point);
//
...
//        Point point = samplePoint();
//
//        Mockito.when(pointService.create(eq(tripId), any(Point.class))).thenReturn(point);
//
...
//
//        Mockito.when(pointService.update(eq(tripId), eq(10L), any(Point.class))).thenReturn(point);
//
